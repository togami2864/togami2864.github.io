...
筆者が観測しているのはほぼ`JavaScript`及び`TypeScript`で作られているリポジトリです。

#### **issue選び**
取り組みやすいissueを選ぶ際には以下の2点は確保しておきたい。
...
という部分が把握できるのでモチベ的にで取り組みやすいと思います。筆者もこのパターンが一番多いです。
...
筆者は最近 [astro](https://github.com/withastro/astro) というSSGのドキュメントの翻訳レビューをちょくちょくやっています。
こちらはまだまだ重要な部分が翻訳しきれてないのでPR投げてくれると嬉しいです。また、私もPR投げたいので公式discordの`#docs-18n`で見かけたらレビューしてくださると嬉しいです。
